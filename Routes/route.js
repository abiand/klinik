...
route.get('/api/customers', customerController.getAllCustomers);
route.get('/api/kepegawaian', kepegawaianController.getAllKepegawaian);*/
...
route.get('/apps-chat', (req, res, next) => {
    res.render('apps-chat', { layout: 'layout/layout-without-bradcrumb', title: 'Chat', page_title: 'Chat', folder: 'Apps' });
})
...
/* Klinik*/
route.get('/kepegawaian', (req, res, next) => {
    res.render('kepegawaian', { title: 'Kepegawaian', page_title: 'Kepegawaian', folder: 'Tables' });
})/*
route.get('/tables-listjs', (req, res, next) => {
    res.render('tables-listjs', { title: 'List JS', page_title: 'List JS', folder: 'Tables' });
}) */
